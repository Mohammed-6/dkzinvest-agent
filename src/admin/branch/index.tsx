...
import { listBranchProps, branchProps, editBranchProps } from "../types/branch";
...
const Content = () => {
  const [collectdata, setcollectdata] = useState(listBranchProps);
  ...
  const editBranch = (data: branchProps) => {
    seteloading(false);
...
const CreateBranch = (props: editBranchProps) => {
  const [collectdata, setcollectdata] = useState<branchProps>({
    _id: "",
    name: "",
    code: "",
    location: "",
  ...
  return (
    <>
      <div className="card">
        <div className="card-header">
          {collectdata._id !== "" ? "Edit" : "Create"} Branch
        </div>
        <div className="card-body">
          <div className="">
            <label>Name</label>
