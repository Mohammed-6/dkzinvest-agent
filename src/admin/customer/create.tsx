...
import { createCustomer, listCustomer, uploadFile } from "../query/customer";
...
const Content = () => {
  ...
  useEffect(() => {
    ...
    listCustomer().then((cus) => {
      setlistcustomer(cus.data.data);
    });
  }, []);
            ...
            <div className="">
              ...
              <div className="mt-2">
                ...
                <input
                  ...
                  value={collectdata.aadharDetails.aadharNo}
                />
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "aadharDetails")}
                  value={collectdata.aadharDetails.currentAddress}
                />
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "aadharDetails")}
                  value={collectdata.aadharDetails.permanentAddress}
                />
              </div>
              <div className="mt-2">
                <h2 className="text-xl underline mt-3">Aadhar back card</h2>
                <label></label>
                <input
                  type="file"
                  name="aadharBack"
                  className={`w-full rounded-md p-2 ${
                    collectdata.aadharBack.docId !== ""
                      ? "border border-green-500"
                      : "border border-gray-200"
                  }`}
                  onChange={(e) => formFileChange(e)}
            ...
            <div className="">
              ...
              <div className="mt-2">
                ...
                <input
                  ...
                  value={collectdata.panDetails.panNo}
                />
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "panDetails")}
                  value={collectdata.panDetails.nameOnPan}
                />
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "panDetails")}
                  value={collectdata.panDetails.fatherName}
                />
              </div>
              <div className="mt-2">
                <label>DOB</label>
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "panDetails")}
                  value={collectdata.panDetails.dob}
                />
              </div>
              ...
              <div className="mt-2">
                ...
                <input
                  ...
                  value={collectdata.bankAccountDetails.bankName}
                />
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "bankAccountDetails")}
                  value={collectdata.bankAccountDetails.accountHolderName}
                />
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "bankAccountDetails")}
                  value={collectdata.bankAccountDetails.bankACnumber}
                />
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "bankAccountDetails")}
                  value={collectdata.bankAccountDetails.ifscCode}
                />
              </div>
              <div className="mt-2">
                ...
                <input
                  ...
                  className="w-full rounded-md p-2 border border-gray-200"
                  onChange={(e) => formSChange(e, "bankAccountDetails")}
                  value={collectdata.bankAccountDetails.accountType}
                />
              </div>
              <div className="mt-2">
